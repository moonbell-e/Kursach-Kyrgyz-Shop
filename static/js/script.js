...
.on('click', '.js_buy', function () { orderRequest.showPopup(true, this) })
.on('click', '.js_close-popup', function () { orderRequest.showPopup(false) })
.on('click', '.js_overlay', function () { orderRequest.showPopup(false) })
.on('click', '.js_send', function () { orderRequest.sendOrder(); });
